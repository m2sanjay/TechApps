...
- **MetaMask** — MetaMask is a popular cryptocurrency wallet that supports a broad range of Ethereum-based tokens and non-fungible tokens (NFTs) on supported blockchains. MetaMask is a cryptocurrency wallet that is available as a browser extension to help you store tokens, interact with decentralized applications. In other words, it allows you to interact with dApps in an ordinary Chrome browser. 

## ***Component Architecture Diagram***
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="https://media.geeksforgeeks.org/wp-content/uploads/20200619214524/Tech-Stack-used-for-developing-dApps.png" width="500" height="400">

## ***Dev Cycle***
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="https://media.geeksforgeeks.org/wp-content/uploads/20200619204816/dapp-process.png" width="600" height="500">
...
- [Connect using injected provider - make sure correct account is active](https://mumbai.polygonscan.com/)
- [Create infura account to connect to polygon from trafflre](https://app.infura.io/dashboard)
- [Mnemonics (15 char) - required to conenct infura polygon using traffle](https://iancoleman.io/bip39/)
- [Truffle boxes](https://trufflesuite.com/boxes/)
- Dockerization of dApp
...
# Creating Polygon Box from start
